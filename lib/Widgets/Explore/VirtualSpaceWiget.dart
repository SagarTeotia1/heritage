...
import 'package:heritage/Widgets/Explore/VirtualTour_Screen.dart'; // Fixed import path for VirtualTourScreen
...
class VirtualSpaceWidget extends StatelessWidget {
  ...
  final List<Map<String, String>> virtualTourPlaces = [
    ...
    {
      "image": effiletower,  // Image path for Eiffel Tower (Ensure you have a valid path for this)
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 20), // Padding for the entire widget
      child: Column(
          ...
          return Padding(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(20),  // Rounded corners for each container
                boxShadow: [
                  BoxShadow(
              ...
              child: ClipRRect(
                borderRadius: BorderRadius.circular(20),  // Clip the image within rounded corners
                child: Stack(
                  children: [
                    // Background image
                    Positioned.fill(
  ...
  Widget _buildExploreButton(BuildContext context, Map<String, String> place) {
    return ElevatedButton(
      onPressed: () {
        ...
        Get.to(
          () => VirtualTourScreen(placeId: place["screen"]!), // Fixed the parameter to match VirtualTourScreen constructor
        );
